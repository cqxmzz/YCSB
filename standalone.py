...
if __name__ == "__main__":
    ...
    for txt_file in text:
        for r_perc in work_load_read_percent:
            ...
            chart_name_prefix = "standalone_" + txt_file + "_read_" + str(r_perc)
            ...
            for i in range(len(conf_algo)):
                ...
                for fieldlength in record_size:
                    ...
                    for repeat in range(repeat_time):
                        ...
                        print ""
                        print ""
                        print "Running " + chart_name_prefix + " " + algo + " " + str(repeat)
                ...
                #print chart_name_prefix, "compression_time", algo,chart[chart_name_prefix]["compression_time"][algo]
                #print chart_name_prefix, "decompression_time", algo, chart[chart_name_prefix]["decompression_time"][algo]
                #print chart_name_prefix, "compression_rate", algo, chart[chart_name_prefix]["compression_rate"][algo]
                #print chart_name_prefix, "latency", algo, chart[chart_name_prefix]["latency"][algo]
                #print chart_name_prefix, "throughput", algo, chart[chart_name_prefix]["throughput"][algo]

            # Put vectors into chart_name_prefix_metrix file
            with open(dirname + "/" + chart_name_prefix + "_" + "compression_time", 'w') as f:
                for algo in chart[chart_name_prefix]["compression_time"]:
                    print >> f, algo + " = [ " + \
                        " ".join(str(v) for v in chart[chart_name_prefix]["compression_time"][algo]) + " ]"

            with open(dirname + "/" + chart_name_prefix + "_" + "decompression_time", 'w') as f:
